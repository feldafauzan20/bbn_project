        ...
        <div class="mx-5 lg:mx-36 2xl:mx-61 mt-12 md:mt-18.5 lg:mt-23 max-w-[1500px]">
            ...
            <div>
                ...
                <div class="bg-red-500 grid grid-cols-1 lg:grid-cols-3">
                    <div class="bg-stone-50 w-full md:flex-1 rounded-[20px] shadow-sm overflow-hidden">
                        <!-- Gambar sebagai background -->
                        <div class="relative h-96 2xl:h-56 rounded-t-[20px] px-5 py-7.5 overflow-hidden">
                            <!-- Background image -->
                            <div class="absolute inset-0 bg-cover bg-center"
                                style="background-image: url('{{ asset('images/material/komowrap/img-up-100-material.webp') }}');">
                            </div>
                            <!-- Overlay hitam 50% -->
                            {{-- <div class="absolute inset-0 bg-black/50"></div> --}}
                            ...
                            <div class="relative">
                                <div class="w-28 2xl:w-36 h-28 2xl:h-36">
                                    <img src="{{ asset('images/material/komoproof/img-content-cfp-100-material.webp') }}"
                                        class="object-cover w-full h-full" alt="">
                                </div>
                            </div>
                        </div>
