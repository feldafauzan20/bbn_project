<x-layouts.main-layout>
    ...
    {{-- SERVICES START --}}
    <section>
        <div class="mt-12.5 md:mt-20 mx-5 lg:mx-36 pb-7.5 lg:pb-26 lg:flex lg:justify-between bg-red-500">
                    ...
                    <div class=" bg-stone-50 w-full md:w-80 md: md:flex-1 rounded-[20px] shadow-sm">
                        ...
                        <div class="py-5 px-3">
                            ...
                            <div class="w-70 mb-25">
                                <p class="text-neutral-400 text-lg tracking-tightest font-normal leading-relaxed">
                                    Menunjang
                                    konektivitas, kelancaran transportasi, serta mendukung pertumbuhan infrastruktur
                                    wilayah
                                    secara menyeluruh.</p>
                            </div>
                            <div>
