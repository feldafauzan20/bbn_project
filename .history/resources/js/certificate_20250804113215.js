...
gsap.from("#text-certificate-section", {
    y: 60,
    opacity: 0,
    duration: 1,
    scrollTrigger: {
        trigger: "#text-certificate-section",
        start: "top 80%",
        toggleActions: "play none none none",
    },
});

gsap.from("#certificate-section-row-1", {
    y: 60,
    opacity: 0,
    duration: 1,
    scrollTrigger: {
        trigger: "#certificate-section-row-1",
        start: "top 80%",
        toggleActions: "play none none none",
    },
});

gsap.from("#certificate-section-row-2", {
    y: 60,
    opacity: 0,
    duration: 1,
    scrollTrigger: {
        trigger: "#certificate-section-row-2",
        start: "top 80%",
        toggleActions: "play none none none",
    },
});
