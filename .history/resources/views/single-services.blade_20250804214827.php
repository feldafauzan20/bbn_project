        ...
        <div class="bg-red-300 mt-12.5 mx-5">
            <div>
                ...
                <div class="bg-yellow-400">
                    <ol
                        class="list-decimal marker:text-xl pl-5 marker:font-semibold marker:leading-tight marker:tracking-tightest marker:pr-10 gap-y-6 text-sm text-black max-w-xl tracking-tightest">
                        <li>
