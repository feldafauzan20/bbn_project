    ...
    <section>
        <div class="bg-red-300 mt-12.5 mx-5">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-1">
                <div class="w-full h-64 p-7 bg-stone-50 rounded-2xl flex flex-col justify-start items-start gap-5">
                    <div class="bg-red-400">
                        <h2 class="text-black text-2xl font-semibold leading-7">Follow Us on Social Media</h2>
                    </div>
                </div>
            </div>
        </div>
