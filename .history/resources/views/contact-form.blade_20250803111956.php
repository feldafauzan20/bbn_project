    ...
    <section>
        <div class="relative">
            ...
            <div class="relative h-fit w-full">
                <div class="pt-32 pb-14 md:pb-20 mx-5 lg:mx-36 2xl:mx-61 flex flex-col lg:flex-row lg:justify-between"
                    ...
                    <div class="md:px-3 lg:px-0 xl:w-full">
                        <div
                            class="p-5 md:p-12 bg-neutral-900/80 rounded-[20px] outline-1 outline-offset-[-1px] outline-black xl:bg-red-400">
                            <form action="" method="">
