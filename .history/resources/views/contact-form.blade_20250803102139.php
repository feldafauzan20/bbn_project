            ...
            <div class="relative h-fit w-full">
                <div class="pt-32 pb-14 mx-5 flex flex-col md:bg-red-300" id="big-hero-content-1">
                    <div class=" mx-auto w-96 md:w-full mb-5 md:bg-yellow-400">
                        <h2
                            class="text-5xl text-center md:text-5xl leading-[49.92px] lg:text-8xl font-semibold tracking-tightest text-white ">
                            Mari Terhubung
                        </h2>
                    </div>
                    ...
                    <div class="p-5 bg-neutral-900/80 rounded-[20px] outline-1 outline-offset-[-1px] outline-black">
                        <form action="" method="">
                            ...
                            <div>
                                <button type="submit"
                                    class="flex items-center justify-between bg-white text-black font-semibold w-full max-w-md px-4 py-2 rounded-full shadow-md hover:bg-white/80 hover:cursor-pointer transition duration-300">
