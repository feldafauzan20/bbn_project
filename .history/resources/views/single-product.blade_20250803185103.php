<x-layouts.main-layout>
    ...
    {{-- DESCRIPTION START --}}
    <section>
        <div class="mx-5 mt-18 md:mt-7 mb-12.5 md:mb-8 md:bg-red-400">
            <div class="w-96 mb-12.5 md:mb-30 md:w-100 bg-yellow-300">
            ...
            <div class="md:flex md:justify-between">
                <div class="flex bg-purple-300 md:h-20">
                    <a href=""
        ...
        <div class="md:h-80">
            <img src="{{ asset('images/single-product/img-house-single-product.webp') }}" class="md:object-cover"
                alt="">
        </div>
    </section>
    {{-- DESCRIPTION END --}}
