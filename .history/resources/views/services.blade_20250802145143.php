<x-layouts.main-layout>
    ...
    {{-- HERO START --}}
    <section>
        <div class="mx-5 lg:mx-36 pt-22 md:pt-34 pb-20 lg:bg-red-400">
            <div class="mx-auto w-96 md:w-[530px] lg:w-[736px] mb-8.5 ">
                <h2
                    class="text-center text-black text-5xl lg:text-8xl font-semibold leading-[49.92px] tracking-tightest">
    ...
    {{-- SERVICES START --}}
    <section>
        <div class="mx-5 lg:mx-36 2xl:mx-61 mb-12">
            <div class="flex md:w-full lg:bg-red-300 lg:justify-center flex-wrap gap-y-12.5 px-5 md:px-0 md:gap-x-7.5">
