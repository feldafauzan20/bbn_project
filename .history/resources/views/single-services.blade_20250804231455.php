    ...
    <section>
        <div class="mx-5 lg:mx-36 2xl:mx-61 mb-12 max-w-[1500px]" id="services-section">
            ...
            <div class="flex md:w-full lg:justify-center flex-wrap gap-y-12.5 px-5 md:px-0 md:gap-x-7.5">
                ...
                {{-- CARD 3 --}}
                <div class=" bg-stone-50 w-full md:w-80 rounded-[20px] shadow-sm">
                    <div>
                        <img class="rounded-t-[20px] object-cover w-full h-80"
                ...
                {{-- CARD 4 --}}
                <div
                    class=" bg-stone-50 w-full md:w-80 lg:basis-[33%] lg:mx-auto md:flex-1 lg:flex-none rounded-[20px] shadow-sm">
                    <div>
                        <img class="rounded-t-[20px] object-cover w-full h-80"
