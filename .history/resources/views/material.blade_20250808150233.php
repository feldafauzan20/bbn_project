                ...
                <div
                    ...
                    <div class="h-[424px] lg:h-[323px]">
                        <div class="bg-stone-50 h-96 md:h-72 flex items-center justify-center">
                            <div class="w-60 h-24">
                                <img src="{{ asset('images/material/perkuatan-beton/img-hammer-test-material.webp') }}"
                    ...
                    <div class="h-[424px] lg:h-[323px]">
                        <div class="bg-stone-50 h-96 md:h-72 flex items-center justify-center">
                            <div class="w-36 h-36">
                                <img src="{{ asset('images/material/perkuatan-beton/img-profometer-material.webp') }}"
                    ...
                    <div class="h-[424px] lg:h-[323px]">
                        <div class="bg-stone-50 h-96 md:h-72 flex items-center justify-center">
                            <div class="w-36 h-36">
                                <img src="{{ asset('images/material/perkuatan-beton/img-thickness-gauge-material.webp') }}"
                    ...
                    <div class="h-[424px] lg:h-[323px]">
                        <div class="bg-stone-50 h-96 md:h-72 flex items-center justify-center">
                            <div class="w-44 h-36">
                                <img src="{{ asset('images/material/perkuatan-beton/img-upv-undit-material.webp') }}"
                    ...
                    <div class="h-[424px] lg:h-[323px]">
                        <div class="bg-stone-50 h-96 md:h-72 flex items-center justify-center">
                            <div class="w-16 h-36">
                                <img src="{{ asset('images/material/perkuatan-beton/img-core-drill-material.webp') }}"
                                    class="w-full h-full object-cover" alt="Gambar UPV Undit">
                            </div>
                        </div>
                        <div>
