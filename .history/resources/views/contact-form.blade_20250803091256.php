                        ...
                        <div>
                            <form action="">
                                ...
                                <div class="w-full h-10 relative">
                                    <div
                                        class="left-[150px] top-[11px] absolute justify-start text-black text-base font-semibold font-['Inter_Tight']">
                                        Submit form</div>
                                    <div class="w-10 h-10 left-[346px] top-0 absolute">
                                        <div class="w-10 h-10 left-0 top-0 absolute bg-sky-500 rounded-full"></div>
                                        <div
                                            class="w-2.5 h-1 left-[15px] top-[22.78px] absolute origin-top-left -rotate-45 border-2 border-white">
                                        </div>
                                    </div>
                                </div>
                            </form>
