<x-layouts.main-layout>
    ...
    {{-- DESCRIPTION START --}}
    <section>
        <div class="mx-5 lg:mx-36  lg:bg-red-300 mt-18 md:mt-7 lg:mt-29.5 mb-12.5 md:mb-8 lg:mb-31">
            <div class="w-96 mb-12.5 md:mb-30 md:w-100 lg:bg-yellow-500">
        ...
        <div class="md:h-80 lg:mx-36 lg:h-130 2xl:h-[740px] lg:rounded-2xl lg:overflow-hidden">
    ...
    <section>
        <div class="mx-5 lg:mx-36 my-12.5 md:my-12.5 lg:my-25 lg:bg-red-400">
            <div class="w-96 md:w-110 lg:w-[578px] mb-12.5 lg:mb-25">
            ...
            <div
                ...
                <div class="w-80 md:w-full h-96 lg:h-150 2xl:h-[588px] rounded-2xl overflow-hidden">
