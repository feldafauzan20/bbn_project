    ...
    <section>
        <div class="mx-5 lg:mx-36 2xl:mx-61 mt-12 md:mt-18.5 lg:mt-23 max-w-[1500px]">
            ...
            <div>
                ...
                {{-- Mata Gerinda --}}
                <div class="flex gap-x-7.5 bg-red-300 w-[1734px]">
                    <div class="bg-yellow-500 w-[289px]">
                        <div class="bg-stone-500 flex justify-center items-center h-72">
                            <img src="{{ asset('images/material/mata-gerinda/img-content-polishing-4-material.webp') }}"
                                alt="" class="object-cover w-40 h-40 ">
                        </div>
                        <div class="flex justify-between">
                            <div class="text-black text-lg font-medium leading-relaxed tracking-tightest">
                                <p>Polishing</p>
                            </div>
                            <div>
                                <p class="text-neutral-400 text-lg font-medium leading-relaxed tracking-tightest">
                                    4”
                                </p>
                            </div>
                        </div>
