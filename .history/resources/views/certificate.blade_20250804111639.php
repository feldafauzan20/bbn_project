<x-layouts.main-layout>
    ...
    <section>
        <div class="relative">
            ...
            <div class="relative h-fit w-full">
                <div class="pt-32 pb-5 lg:pb-30 mx-5 lg:mx-36 lg:bg-red-500 2xl:mx-61 flex flex-col lg:flex-row lg:justify-between max-w-[1500px]"
                    id="hero-section">
                    <div class="lg:bg-blue-400 lg:mx-auto">
                        ...
                        <div class="w-96 md:w-120 lg:bg-yellow-800 mx-auto mb-15 md:mb-16 lg:mb-20.5">
                            <p
    ...
    <section>
        <div class="mx-5 my-14.5 md:my-14 ">
            <div class="w-96 lg:w-170 mx-auto mb-0 lg:mb-5.5">
                <h2
            ...
            <div class="w-96 md:w-120 lg:bg-yellow-800 mx-auto mb-0 md:mb-16 lg:mb-20.5">
