        ...
        <div class="mx-5 lg:mx-36 2xl:mx-61 mt-12 md:mt-18.5 lg:mt-23 max-w-[1500px]">
            ...
            <div>
                ...
                <div class="bg-red-500 grid grid-cols-1 lg:grid-cols-3">
                    <div class="bg-stone-50 w-full md:flex-1 rounded-[20px] shadow-sm overflow-hidden">
                        <div
                            class="h-96 flex justify-center items-center 2xl:h-56 rounded-t-[20px] px-5 py-7.5 overflow-hidden relative">
                            <!-- Efek glow -->
                            <div
                                class="absolute w-60 2xl:w-36 h-56 2xl:h-36 bg-black opacity-70 blur-2xl rounded-full -z-10">
                            </div>

                            <!-- Gambar produk -->
                            <div class="w-60 2xl:w-36 h-56 2xl:h-36 relative z-10">
