    ...
    <section>
        <div class="bg-red-400 mx-5 mt-18">
            ...
            <div class="bg-amber-700">
                <div>
                    <a href=""
                        class="px-14 py-7 text-white bg-black rounded-full text-lg tracking-tightest font-semibold leading-tight hover:bg-blue-600 transition duration-500 ">Download
                        our
                        company profile</a>
                </div>
            </div>
