<x-layouts.main-layout>
    ...
    <section>
        <div class="mx-5 lg:mx-36 my-14.5 md:my-14 ">
            <div class="w-96 lg:w-170 mx-auto mb-8 lg:mb-5.5">
                <h2
            ...
            <div class="w-96 md:w-120 lg:w-190 lg:bg-yellow-800 mx-auto mb-8 md:mb-16 lg:mb-20.5">
            ...
            <div
                class="grid grid-cols-1 bg-blue-300 md:grid-cols-2 lg:grid-cols-3 px-5 md:px-0 md:gap-x-20.5 gap-y-15">
