            ...
            <div class="relative h-fit w-full">
                <div class="pt-32 pb-5 mx-5 lg:mx-36 lg:bg-red-500 2xl:mx-61 flex flex-col lg:flex-row lg:justify-between max-w-[1500px]"
                    ...
                    <div class="lg:bg-blue-400 lg:mx-auto">
                        <div class="w-96 lg:w-150 mx-auto mb-8">
                            <h2
                                class="text-white text-center text-5xl lg:text-8xl font-semibold tracking-tightest leading-[49.92px] lg:leading-[89.44px]">
