<x-layouts.main-layout>
    ...
    <section>
        <div class="relative">
            ...
            <div class="relative h-fit w-full">
                <div class="pt-32 pb-29.5 bg-blue-400 md:pb-26.5 lg:pb-45 mx-5 lg:mx-36 2xl:mx-61 max-w-[1500px]  lg:h-full lg:flex lg:items-center"
                    id="hero-section">
                    ...
                    <div class="w-87 mx-auto md:w-120 lg:w-200">
                        <p
    ...
    <section>
        <div class="bg-red-300 mt-12.5 mx-5">
            <div>
                <div class="pb-8.5">
                    <h2 class="text-black text-4xl font-semibold leading-10 tracking-tightest">Bangunan gedung</h2>
                </div>
                <div class="w-86 pb-12.5">
                    <p class="text-black text-lg font-normal leading-relaxed tracking-tightest">Architectural design is
                        at the core of our
                ...
                <div class="pb-10.5 bg-blue-400">
                    <h3 class="text-black text-3xl font-semibold leading-loose tracking-tightest">Key Features:</h3>
                </div>
                <div class="bg-yellow-400">
                    <div class="space-y-6 text-sm text-gray-800 max-w-xl">
                        <!-- ITEM 1 -->
                        <div class="flex items-start gap-4">
                            <span class="text-lg font-bold text-black">1.</span>
                            <p class="font-bold text-black">Concept Development:</p>
                        </div>
                        <p>
                            The first step in our architectural design process involves understanding the client’s
                            vision and the project’s context.
                            We conduct thorough research and analysis, including site assessments, feasibility studies,
                            and environmental considerations.
                            Our team then develops initial design concepts that align with the client’s needs and
                            aspirations.
                        </p>

                        <!-- ITEM 2 -->
                        <div class="flex items-start gap-4">
                            <span class="text-lg font-bold text-black">2.</span>
                            <p class="font-bold text-black">Detailed Design:</p>
                        </div>
                        <p>
                            ...
                            floor plans, elevations, and 3D renderings. We pay close attention to aspects such as
                            spatial planning, lighting, material selection,
                        ...
                        <div class="flex items-start gap-4">
                            ...
                            <p class="font-bold text-black">Sustainable Practices:</p>
                        </div>
                        <p>
                            Sustainability is a critical component of our architectural design services. We incorporate
                            eco-friendly materials,
                            energy-efficient systems, and sustainable construction practices. Our designs aim to reduce
                            environmental impact while
                            enhancing the comfort and wellbeing of the occupants.
                        </p>

                        <!-- ITEM 4 -->
                        <div class="flex items-start gap-4">
                            <span class="text-lg font-bold text-black">4.</span>
                            <p class="font-bold text-black">Collaborative Approach:</p>
                        </div>
                        <p>
                            We believe in a collaborative design process, working closely with our clients, consultants,
                            and stakeholders.
                            This ensures that the final design aligns with the client’s vision, budget, and schedule.
                        </p>

                        <!-- ITEM 5 -->
                        <div class="flex items-start gap-4">
                            <span class="text-lg font-bold text-black">5.</span>
                            <p class="font-bold text-black">Regulatory Compliance:</p>
                        </div>
                        <p>
                            Our architectural designs adhere to all relevant building codes and regulations.
                            We stay updated with the latest standards and requirements, ensuring that our projects are
                            compliant and secure.
                        </p>

                        <!-- ITEM 6 -->
                        <div class="flex items-start gap-4">
                            <span class="text-lg font-bold text-black">6.</span>
                            <p class="font-bold text-black">Innovation and Technology:</p>
                        </div>
                        <p>
                            We leverage the latest technology and software in our design process, including Building
                            Information Modeling (BIM)
                            and 3D visualization tools. This allows us to create detailed and accurate representations
                            of the final project.
                        </p>

                        <!-- ITEM 7 -->
                        <div class="flex items-start gap-4">
                            <span class="text-lg font-bold text-black">7.</span>
                            <p class="font-bold text-black">Execution and Support:</p>
                        </div>
                        <p>
                            Our involvement doesn’t end with the design. We provide ongoing support throughout the
                            construction phase,
                            ensuring a smooth and successful project delivery.
                        </p>
                    </div>
