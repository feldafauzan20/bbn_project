                    ...
                    <div id="big-hero-content-1" class="pt-32 mx-5 bg-blue-500 flex flex-col">
                        ...
                        <div>
                            <form action="">
                                <div class="mb-5">
                                    <label for="name"
                                        class="block mb-2 tracking-tightest text-white text-sm font-medium text-gray-900">Nama</label>
                                    <input type="name" id="name"
                                        class="shadow-xs bg-neutral-800 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
