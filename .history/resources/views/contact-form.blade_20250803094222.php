            ...
            <div class="relative">
                ...
                <div class="relative h-fit w-full">
                    <div id="big-hero-content-1" class="pt-32 mx-5 bg-blue-500 flex flex-col">
                        ...
                        <div class="w-[398px] bg-yellow-400 mb-13">
                        ...
                        <div class="p-5 bg-neutral-900/80 rounded-[20px] outline-1 outline-offset-[-1px] outline-black">
                            <form action="">
                                <div class="mb-2.5">
                                    <label for="name"
                                ...
                                <div>
                                    <button type="submit"
                                        class="flex items-center justify-between bg-white text-black font-medium w-full max-w-md px-4 py-2 rounded-full shadow-md hover:shadow-lg transition duration-300">
                                        <span class="mx-auto">Submit form</span>
                                        <span
                                            class="flex items-center justify-center w-8 h-8 rounded-full bg-blue-500 text-white ml-2">
                                            <!-- Ikon panah keluar -->
