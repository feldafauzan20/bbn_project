    ...
    <section>
        <div class="mx-5 lg:mx-36 2xl:mx-61 mt-12 md:mt-18.5 lg:mt-23 max-w-[1500px]">
            ...
            <div>
                ...
                {{-- Mata Gerinda --}}
                <div class="swiper mySwiper bg-red-300 px-4">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide bg-white w-[289px] sm:w-[250px] md:w-[289px]">
                            ...
                            <div class="flex justify-between">
                                <p class="text-black text-lg font-medium">Polishing</p>
                                <p class="text-neutral-400 text-lg font-medium">4”</p>
                            </div>
                        </div>
