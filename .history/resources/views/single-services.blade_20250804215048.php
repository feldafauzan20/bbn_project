        ...
        <div class="bg-red-300 mt-12.5 mx-5">
            <div>
                ...
                <div class="bg-yellow-400">
                    <ol
                        class="list-decimal list-outside pl-10 marker:text-xl marker:font-semibold marker:leading-tight marker:tracking-tightest gap-y-6 text-sm text-black max-w-xl tracking-tightest">
                        <li>
                            <p class="font-bold">Concept Development:</p>
                            <p>
                        ...
                        <li>
                            <p class="font-bold">Detailed Design:</p>
                            <p>
                        ...
                        <li>
                            <p class="font-bold">Sustainable Practices:</p>
                            <p>
                        ...
                        <li>
                            <p class="font-bold">Collaborative Approach:</p>
                            <p>
                        ...
                        <li>
                            <p class="font-bold">Innovation and Technology:</p>
                            <p>
                        ...
                        <li>
                            <p class="font-bold">Execution and Support:</p>
                            <p>
