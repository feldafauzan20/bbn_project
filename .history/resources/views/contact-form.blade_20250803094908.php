                ...
                <div id="big-hero-content-1" class="pt-32 mx-5 flex flex-col">
                    ...
                    <div class="p-5 bg-neutral-900/80 rounded-[20px] outline-1 outline-offset-[-1px] outline-black">
                        <form action="" method="">
                            ...
                            <div>
                                <button type="submit"
                                    class="flex items-center justify-between bg-white text-black font-semibold w-full max-w-md px-4 py-2 rounded-full shadow-md hover:bg-white/80 transition duration-300">
