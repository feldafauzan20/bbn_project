    ...
    <section>
        <div class="relative">
            ...
            <div class="relative h-fit w-full">
                <div class="pt-32 pb-14 md:pb-20 mx-5 lg:mx-36 flex flex-col lg:flex-row md:bg-red-300"
                    id="big-hero-content-1">
                    <div class="lg:bg-purple-400">
                        <div class=" mx-auto w-96 md:w-full lg:w-120 mb-5 md:bg-yellow-400">
                            <h2
                                class="text-5xl text-center lg:text-start md:text-5xl leading-[49.92px] md:leading-[49.92px] lg:text-8xl font-semibold tracking-tightest text-white ">
                                Mari Terhubung
                            </h2>
                        </div>
                    ...
                    <div class="md:px-3 lg:bg-cyan-300">
                        <div
