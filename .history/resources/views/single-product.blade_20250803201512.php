<x-layouts.main-layout>
    ...
    <section>
        <div class="relative">
            ...
            <div class="relative h-fit w-full">
                <div class="pt-32 pb-31 md:pb-26.5 lg:pb-45 mx-5 lg:mx-36 2xl:mx-61 max-w-[1500px] lg:bg-red-300  lg:h-full lg:flex lg:items-center"
                    id="hero-section">
    ...
    {{-- DESCRIPTION START --}}
    <section>
        <div class="mx-5 lg:mx-36 mt-18 md:mt-7 mb-12.5 md:mb-8 ">
