<x-layouts.main-layout>
    ...
    <section>
        <div class="relative">
            ...
            <div class="relative h-fit w-full">
                <div class="pt-32 pb-29.5 md:pb-26.5 lg:pb-45 mx-5 lg:mx-36 2xl:mx-61 max-w-[1500px]  lg:h-full lg:flex lg:items-center"
                    id="hero-section">
                    ...
                    <div class="w-87 md:bg-red-400 mx-auto md:w-110 lg:w-200">
                        <p class="text-white text-lg text-center lg:text-8xl tracking-tightest lg:leading-[104px]">
    ...
    <section>
        <div class="mt-12.5 mx-5 pb-7.5">
            ...
            <div class="grid grid-cols-1 place-items-center gap-y-7.5 md:grid-cols-2 lg:grid-cols-1 px-5">
