<x-layouts.main-layout>
    ...
    <section>
        <div class="bg-red-400 mx-5 mt-12">
            <div class="flex w-96 flex-wrap gap-x-2.5 gap-y-15 bg-blue-600">
                <a href="">Material Komofloor</a>
                <a href="">Material Komowrap</a>
                <a href="">Perkuatan Struktur</a>
                <a href="">Material Komoproof</a>
                <a href="">Mesin dan Perlengkapan</a>
                <a href="">Mata Gerinda</a>
            </div>
        </div>
    </section>
    {{-- MATERIAL END --}}
