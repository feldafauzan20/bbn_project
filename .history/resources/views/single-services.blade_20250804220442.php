        ...
        <div class="bg-red-300 mt-12.5 mx-5">
            <div class="mb-7.5">
                ...
                <div class="bg-yellow-400">
                    <ol
                        class="list-decimal list-outside marker:text-xl marker:font-semibold marker:leading-tight pl-6 space-y-7 text-sm text-black max-w-xl tracking-tightest">
                        <li class="pl-2">
            ...
            <div>
                <p class="text-black text-2xl font-semibold tracking-tightest leading-normal">Architectural design is
                    more than just
                    creating buildings; it’s about crafting spaces that inspire and function seamlessly within their
                    environment. Our team is dedicated to delivering innovative and sustainable designs that reflect the
                    unique identity and needs of each client. Whether it's a residential, commercial, or public project,
                    we bring our passion and expertise to every design, ensuring the highest standards of quality and
                    excellence.</p>
            </div>
        </div>
    </section>
