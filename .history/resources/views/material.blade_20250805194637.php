<x-layouts.main-layout>
    ...
    <section class="lg:flex lg:gap-x-12" id="hero-section">
        <div class="mx-5 lg:mx-0 lg:ml-36 lg:bg-yellow-400 2xl:ml-61 pt-40 ">
            <div>
    ...
    {{-- MATERIAL START --}}
    <section>
        <div class="md:bg-red-400 mx-5 lg:mx-36 2xl:mx-61 mt-12 md:mt-18.5 lg:mt-23">
            <div class="flex w-96 md:w-150 lg:w-full flex-wrap gap-y-2.5 gap-x-15 lg:gap-x-16.5 lg:bg-blue-600 mb-18">
            ...
            {{-- Komofloor --}}
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 md:gap-x-3 gap-y-4 md:gap-y-5">
                <div class="bg-stone-50 w-full md:flex-1 2xl:h-96 rounded-[20px] shadow-sm overflow-hidden">
                    <!-- Gambar sebagai background -->
                    <div class="relative h-40 rounded-t-[20px] px-5 py-7.5 overflow-hidden">
                        <!-- Background image -->
                ...
                <div class="bg-stone-50 w-full md:flex-1 2xl:h-96 rounded-[20px] shadow-sm overflow-hidden">
                    ...
                    <div class="relative h-40 rounded-t-[20px] px-5 py-7.5 overflow-hidden">
                        <!-- Background image -->
                        <div class="absolute inset-0 bg-cover bg-center"
                            style="background-image: url('{{ asset('images/material/img-epoxys-self-leveling-material.webp') }}');">
                        </div>
                        <!-- Overlay hitam 50% -->
                        <div class="absolute inset-0 bg-black/50"></div>
                        ...
                        <div class="relative">
                            <div class="w-28 h-28">
                                <img src="{{ asset('images/material/img-content-epoxys-self-leveling-material.webp') }}"
                                    class="object-cover w-full h-full" alt="">
                            </div>
                        </div>
                    </div>
                ...
                <div class="bg-stone-50 w-full md:flex-1 2xl:h-96 rounded-[20px] shadow-sm overflow-hidden">
                    ...
                    <div class="relative h-40 rounded-t-[20px] px-5 py-7.5 overflow-hidden">
                        <!-- Background image -->
                        <div class="absolute inset-0 bg-cover bg-center"
                            style="background-image: url('{{ asset('images/material/img-epoxys-self-leveling-top-coat.webp') }}');">
                        </div>
                        <!-- Overlay hitam 50% -->
                        <div class="absolute inset-0 bg-black/50"></div>
                        ...
                        <div class="relative">
                            <div class="w-28 h-28">
                                <img src="{{ asset('images/material/img-content-epoxys-self-leveling-top-coat-material.webp') }}"
                                    class="object-cover w-full h-full" alt="">
                            </div>
                        </div>
                    </div>
                ...
                <div class="bg-stone-50 w-full md:flex-1 2xl:h-96 rounded-[20px] shadow-sm overflow-hidden">
                    ...
                    <div class="relative h-40 rounded-t-[20px] px-5 py-7.5 overflow-hidden">
                        <!-- Background image -->
                        <div class="absolute inset-0 bg-cover bg-center"
                            style="background-image: url('{{ asset('images/material/img-epoxy-self-leveling-material-2.webp') }}');">
                        </div>
                        <!-- Overlay hitam 50% -->
                        <div class="absolute inset-0 bg-black/50"></div>
                        ...
                        <div class="relative">
                            <div class="w-28 h-28">
                                <img src="{{ asset('images/material/img-content-epoxy-self-leveling-material-2.webp') }}"
                                    class="object-cover w-full h-full" alt="">
                            </div>
                        </div>
                    </div>
                ...
                <div class="bg-stone-50 w-full md:flex-1 2xl:h-96 rounded-[20px] shadow-sm overflow-hidden">
                    ...
                    <div class="relative h-40 rounded-t-[20px] px-5 py-7.5 overflow-hidden">
                        <!-- Background image -->
                        <div class="absolute inset-0 bg-cover bg-center"
                            style="background-image: url('{{ asset('images/material/img-epoxy-coating-material.webp') }}');">
                        </div>
                        <!-- Overlay hitam 50% -->
                        <div class="absolute inset-0 bg-black/50"></div>
                        ...
                        <div class="relative">
                            <div class="w-28 h-28">
                                <img src="{{ asset('images/material/img-content-epoxy-coating-material.webp') }}"
                                    class="object-cover w-full h-full" alt="">
                            </div>
                        </div>
                    </div>
                ...
                <div class="bg-stone-50 w-full md:flex-1 2xl:h-96 rounded-[20px] shadow-sm overflow-hidden">
                    ...
                    <div class="relative h-40 rounded-t-[20px] px-5 py-7.5 overflow-hidden">
                        <!-- Background image -->
                        <div class="absolute inset-0 bg-cover bg-center"
                            style="background-image: url('{{ asset('images/material/img-epoxy-non-slip-coating-material.webp') }}');">
                        </div>
                        <!-- Overlay hitam 50% -->
                        <div class="absolute inset-0 bg-black/50"></div>
