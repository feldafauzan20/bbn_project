<x-layouts.main-layout>
    ...
    <section>
        <div class="relative">
            ...
            <div class="relative h-fit w-full">
                <div class="pt-32 pb-31 md:pb-20 mx-5 lg:mx-36 2xl:mx-61 max-w-[1500px]" id="hero-section">
                    <div class="w-96">
    ...
    {{-- DESCRIPTION START --}}
    <section>
        <div class="mx-5 mt-18 mb-12.5">
            <div class="w-96 mb-12.5">
        ...
        <div>
            <img src="{{ asset('images/single-product/img-house-single-product.webp') }}" alt="">
        </div>
    </section>
    {{-- DESCRIPTION END --}}
    ...
    <section>
        <div class="mx-5 my-12.5">
            ...
            <div class="grid place-items-center grid-cols-1 md:grid-cols-2 gap-y-12.5">
                <div class="w-80 h-96 rounded-2xl overflow-hidden">
    ...
    {{-- NEXT PROJECTS START --}}
    <section>
        <div class="mx-5 mb-10.5 lg:mx-36 2xl:mx-61 mt-12.5 md:mt-20 lg:mt-29 bg-red-500 md:mb-20 lg:mb-8 max-w-[1500px]"
            id="journal-section">
            ...
            <div class="flex justify-center bg-blue-400 py-10">
                <a href="#"
                    class="inline-flex items-center bg-black text-white text-lg font-semibold tracking-tightest rounded-full px-8 py-4 hover:bg-blue-600 transition duration-500 space-x-4">

                    <span>Back to all projects</span>

                    <span class="flex items-center justify-center w-8 h-8 bg-white text-black rounded-full">
                        <!-- Panah kanan SVG -->
