<x-layouts.main-layout>
    ...
    {{-- DESCRIPTION START --}}
    <section>
        <div class="mx-5 lg:mx-36 2xl:mx-61 mt-18 md:mt-7 lg:mt-29.5 mb-12.5 md:mb-8 lg:mb-31">
    ...
    <section>
        <div class="mx-5 lg:mx-36 my-12.5 md:my-12.5 lg:my-25">
            ...
            <div
                class="grid place-items-center md:place-items-stretch grid-cols-1 md:grid-cols-2 gap-y-12.5 md:gap-x-7.5">
