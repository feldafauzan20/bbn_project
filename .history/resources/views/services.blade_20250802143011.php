        ...
        <div class="mx-5 mb-12 md:bg-red-400">
            <div class="flex md:w-full flex-wrap gap-y-12.5 px-5 md:px-0 md:gap-x-7.5">
                ...
                <div class=" bg-stone-50 w-full md:w-80 md:flex-1 rounded-[20px] shadow-sm">
                    ...
                    <div class="py-5 px-3 bg-yellow-400">
                    ...
                    <div class="bg-red-300 px-3">
                        <a href=""
                            class="self-stretch justify- md:items-end text-black text-lg font-semibold tracking-tightest underline leading-relaxed">View
                            more</a>
                    </div>
                </div>
