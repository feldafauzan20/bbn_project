<x-layouts.main-layout>
    ...
    <section>
        <div class="mx-5 md:bg-red-400 mb-10.5 lg:mx-36 2xl:mx-61 mt-12.5 md:mt-20 lg:mt-29 md:mb-20 lg:mb-8 max-w-[1500px]"
            id="journal-section">
            <div class="md:flex md:justify-between bg-blue-400">
                <div class="w-full md:flex md:items-center md:w-110 bg-yellow-400 lg:w-200 mb-8 md:mb-9.5">
                    <h2
                        class="text-black text-5xl lg:text-6xl font-semibold tracking-tightest lg:tracking-tighter text-center md:text-start leading-10 md:leading-13">
                        Next Projects</h2>
                </div>
                <div class="flex justify-center mb-12.5 bg-amber-700">
                    <a href="#"
