<x-layouts.main-layout>
    ...
    <section class="lg:flex lg:gap-x-12" id="hero-section">
        <div class="mx-5 lg:mx-0 lg:ml-36 lg:bg-yellow-400 2xl:ml-61 pt-40 ">
            ...
            <div class="w-96 lg:w-160 my-5 md:my-8.5 lg:my-3.5">
                <h2
                    class="text-black text-5xl lg:text-8xl leading-[49.92px] lg:leading-18 font-semibold tracking-tightest">
    ...
    {{-- MATERIAL START --}}
    <section>
        <div class="md:bg-red-400 mx-5 mt-12 md:mt-18.5">
            <div class="flex w-96 md:w-150 flex-wrap gap-y-2.5 gap-x-15 md:bg-blue-600 mb-18">
