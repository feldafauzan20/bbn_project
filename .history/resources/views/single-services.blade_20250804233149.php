<x-layouts.main-layout>
    ...
    <section>
        <div class="mt-12.5 md:mt-20 mx-5 lg:mx-36 pb-7.5 lg:flex lg:justify-between bg-red-500">
            ...
            <div
                class="grid grid-cols-1 bg-cyan-600 place-items-center lg:place-items-start gap-y-7.5 lg:gap-y-0 md:grid-cols-2 lg:grid-cols-1 px-5 md:px-0 md:gap-x-7.5 lg:gap-x-0">
