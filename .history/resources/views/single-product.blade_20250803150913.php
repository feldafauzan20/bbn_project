    ...
    <section>
        <div class="mx-5 mb-10.5 lg:mx-36 2xl:mx-61 mt-12.5 md:mt-20 lg:mt-29 bg-red-500 md:mb-20 lg:mb-8 max-w-[1500px]"
            ...
            <div class="flex justify-center bg-blue-400">
                <a href="#"
                    class="inline-flex items-center bg-black text-white text-lg font-semibold tracking-tightest rounded-full px-8 py-7 hover:bg-blue-600 transition duration-500 space-x-4">
