<x-layouts.main-layout>
    ...
    {{-- HERO START --}}
    <section>
        <div class="mx-5 pt-22 md:pt-34 pb-20 md:bg-red-800">
            <div class="mx-auto w-96 md:w-[530px] mb-8.5 md:bg-yellow-300">
                <h2 class="text-center text-black text-5xl font-semibold leading-[49.92px] tracking-tightest">
                    Layan Konstruksi <br /> dan Struktur Menyeluruh
                </h2>
            </div>
    ...
    {{-- SERVICES START --}}
    <section>
        <div class="mx-5 mb-12 bg-red-400">
