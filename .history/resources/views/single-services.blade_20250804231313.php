<x-layouts.main-layout>
    ...
    <section>
        <div class="mx-5 lg:mx-36 2xl:mx-61 mb-12 max-w-[1500px]" id="services-section">
            <div class="lg:flex lg:justify-between md:mb-9.5 lg:mb-7.5">
                <div class="w-full bg-red-400 lg:flex lg:items-center lg:w-200 mb-8 md:mb-0">
                    <h2
                        class="text-black md:text-center text-5xl lg:text-6xl font-semibold tracking-tightest lg:tracking-tighter text-center md:text-start leading-10 md:leading-[52px] lg:leading-[83.20px]">
