        ...
        <div class="bg-red-300 mt-12.5 mx-5">
            <div>
                ...
                <div class="bg-yellow-400">
                    <ol
                        class="list-decimal list-outside marker:text-xl marker:font-semibold marker:leading-tight pl-6 gap-y-6 text-sm text-black max-w-xl tracking-tightest">
                        <li class="pl-2">
                            <p class="font-bold text-xl">Concept Development:</p>
                            <p>
