            ...
            <div class="relative h-fit w-full">
                <div class="pt-32 pb-14 md:pb-20 mx-5 lg:mx-36 2xl:mx-61 flex flex-col lg:flex-row lg:justify-between max-w-[1500px]"
                    ...
                    <div class="bg-red-600">
                        ...
                        <div class="bg-yellow-600 w-96 mx-auto mb-15">
                            <p
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 bg-blue-300 px-5">
                            <div class="">
                                <div>
                                ...
                                <div>
                                    <p class="text-white text-base font-semibold leading-normal">KOMOPOXY & KOMOPROOF
                                    </p>
                                </div>
                            </div>
                        </div>
