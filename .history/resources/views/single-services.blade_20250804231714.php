<x-layouts.main-layout>
    ...
    <section>
        <div class="relative">
            ...
            <div class="relative h-fit w-full">
                <div class="pt-32 pb-29.5 md:pb-29.5 lg:pb-45 mx-5 lg:mx-36 2xl:mx-61 max-w-[1500px]  lg:h-full lg:flex lg:items-center"
                    id="hero-section">
                    ...
                    <div class="w-87 md:bg-red-400 mx-auto md:w-110 lg:w-200">
                        <p
    ...
    <section>
        <div class="mt-12.5 md:mt-20 mx-5 pb-7.5">
            <div class="mb-7.5 md:mb-20 bg-red-400">
                <div class="pb-8.5">
            ...
            <div
                class="grid grid-cols-1 md:bg-yellow-400 place-items-center gap-y-7.5 md:grid-cols-2 lg:grid-cols-1 px-5 md:px-0 md:gap-x-7.5">
                <div class="w-full h-64 p-7 bg-stone-50 rounded-2xl flex flex-col justify-start items-start ">
                    <div>
    ...
    {{-- SERVICES START --}}
    <section>
        <div class="mx-5 lg:mx-36 2xl:mx-61 mb-10 bg-red-500 max-w-[1500px]" id="services-section">
            <div class="lg:flex lg:justify-between md:mb-10 lg:mb-7.5">
                <div class="w-full lg:flex lg:items-center lg:w-200 mb-8">
                    <h2
                        class="text-black text-5xl lg:text-6xl font-semibold tracking-tightest lg:tracking-tighter text-center leading-10 md:leading-[52px] lg:leading-[83.20px]">
            ...
            <div class="flex md:w-full md:justify-center flex-wrap gap-y-12.5 px-5 md:px-0 md:gap-x-7.5">
                ...
                {{-- CARD 4 --}}
                <div
                    class=" bg-stone-50 w-full md:w-80 lg:basis-[33%] lg:mx-auto lg:flex-none rounded-[20px] shadow-sm">
                    <div>
                        <img class="rounded-t-[20px] object-cover w-full h-80"
