    ...
    <section>
        <div class="mx-5 bg-red-400">
            <div class="flex flex-wrap px-5">
                <div>
                    <div class="bg-yellow-700 overflow-hidden h-80 w-full">
                        <img src="{{ asset('images/services/img-building-services.webp') }}"
                            class="h-full w-full object-cover" alt="img-building">
                    </div>
                </div>
            </div>
        </div>
