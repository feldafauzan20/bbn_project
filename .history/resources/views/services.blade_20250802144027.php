        ...
        <div class="mx-5 lg:mx-36 mb-12">
            <div class="flex md:w-full lg:bg-red-300 lg:justify-center flex-wrap gap-y-12.5 px-5 md:px-0 md:gap-x-7.5">
                ...
                <div class="bg-stone-50 w-full md:w-80 md:flex-1 rounded-[20px] shadow-sm flex flex-col">
                    <!-- Gambar -->
                    <img class="rounded-t-[20px] object-cover w-full h-80 lg:h-96"
                ...
                {{-- CARD 4 --}}
                <div class=" bg-stone-50 w-full md:w-80 lg:w-96 md: md:flex-1 lg:flex-none rounded-[20px] shadow-sm">
                    <div>
                        <img class="rounded-t-[20px] object-cover w-full h-80"
