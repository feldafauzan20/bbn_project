        ...
        <div class="mx-5 mb-10.5 lg:mx-36 2xl:mx-61 mt-12.5 md:mt-20 lg:mt-29 bg-red-500 md:mb-20 lg:mb-8 max-w-[1500px]"
            ...
            <div class="flex justify-center bg-blue-400">
                <div>
                    ...
                    <a href=""
                        class="px-14 py-7 text-white bg-black rounded-full text-lg tracking-tightest font-semibold leading-tight hover:bg-blue-600 transition duration-500 ">Back
                        to all projects </a>
                    <span class="flex items-center justify-center w-6 h-6 bg-white text-black rounded-full">
                        <!-- Ikon panah kanan -->
