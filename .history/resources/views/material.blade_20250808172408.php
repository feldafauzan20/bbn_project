    ...
    <section>
        <div class="mx-5 lg:mx-36 2xl:mx-61 mt-12 md:mt-18.5 lg:mt-23 max-w-[1500px]">
            ...
            <div>
                ...
                {{-- <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 md:gap-x-3 lg:gap-x-6.5 gap-y-4 md:gap-y-5 lg:gap-y-6.5"
                    ...
                    <div class="bg-stone-50 w-full md:flex-1 rounded-[20px] shadow-sm overflow-hidden">
                        ...
                        <div class="relative h-40 2xl:h-56 rounded-t-[20px] px-5 py-7.5 overflow-hidden">
                            ...
                            <div class="absolute inset-0 bg-cover bg-center"
                                style="background-image: url('{{ asset('images/material/komofloor/img-ep-1000-material.webp') }}');">
                            </div>
                            <!-- Overlay hitam 50% -->
                            ...
                            <div class="relative">
                                <div class="w-28 2xl:w-36 h-28 2xl:h-36">
                                    <img src="{{ asset('images/material/komofloor/img-content-ep-1000-material.webp') }}"
                    ...
                    <div class="bg-stone-50 w-full md:flex-1 rounded-[20px] shadow-sm overflow-hidden">
                        ...
                        <div class="relative h-40 2xl:h-56 rounded-t-[20px] px-5 py-7.5 overflow-hidden">
                            <!-- Background image -->
                            <div class="absolute inset-0 bg-cover bg-center"
                                style="background-image: url('{{ asset('images/material/komofloor/img-el-2000-material.webp') }}');">
                            </div>
                            <!-- Overlay hitam 50% -->
                            <div class="absolute inset-0 bg-black/50"></div>
                            ...
                            <div class="relative">
                                <div class="w-28 2xl:w-36 h-28 2xl:h-36">
                                    <img src="{{ asset('images/material/komofloor/img-content-el-2000-material.webp') }}"
                                        class="object-cover w-full h-full" alt="">
                                </div>
                            </div>
                        </div>
                ...
                {{-- <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 md:gap-x-3 lg:gap-x-6.5 gap-y-4 md:gap-y-5 lg:gap-y-6.5"
                        ...
                        <div class="py-4 px-5 h-[471px]">
                            ...
                            <div>
                                <ul class="list-disc pl-5 text-zinc-500 text-lg font-normal leading-7 tracking-tighter">
                                    ...
                                    <li>Warna - Abu-abu, Hijau</li>
                                    <li>Rasio Mixing - 4 : 1</li>
                                    <li>Potlife - 20 menit</li>
                                    <li>Kering Sentuh (20°) - 24 menit</li>
                                    <li>Jumlah Teoritis (3 mm) - 4.83kg/m²</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-stone-50 w-full md:flex-1 rounded-[20px] shadow-sm overflow-hidden">
                        ...
                        <div class="relative h-40 2xl:h-56 rounded-t-[20px] px-5 py-7.5 overflow-hidden">
                            <!-- Background image -->
                            <div class="absolute inset-0 bg-cover bg-center"
                                style="background-image: url('{{ asset('images/material/komoproof/img-ut-300-material.webp') }}');">
                            </div>
                            <!-- Overlay hitam 50% -->
                            <div class="absolute inset-0 bg-black/50"></div>
                            ...
                            <div class="relative">
                                <div class="w-28 2xl:w-36 h-28 2xl:h-36">
                                    <img src="{{ asset('images/material/komoproof/img-content-ut-300-material.webp') }}"
                                        class="object-cover w-full h-full" alt="">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="py-4 px-5 h-[471px]">
                            ...
                            <div>
                                <ul class="list-disc pl-5 text-zinc-500 text-lg font-normal leading-7 tracking-tighter">
                                    ...
                                    <li>Rasio Mixing - 3 : 1</li>
                                    <li>Potlife - 3 jam</li>
                                    <li>Kering Sentuh (20°) - 10 menit</li>
                                    <li>Jumlah Teoritis (45μm) - 11.3kg/m²</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-stone-50 w-full md:flex-1 rounded-[20px] shadow-sm overflow-hidden">
                        ...
                        <div class="relative h-40 2xl:h-56 rounded-t-[20px] px-5 py-7.5 overflow-hidden">
                            <!-- Background image -->
                            <div class="absolute inset-0 bg-cover bg-center"
                                style="background-image: url('{{ asset('images/material/komoproof/img-ub-202-material.webp') }}');">
                            </div>
                            <!-- Overlay hitam 50% -->
                            <div class="absolute inset-0 bg-black/50"></div>
                            ...
                            <div class="relative">
                                <div class="w-28 2xl:w-36 h-28 2xl:h-36">
                                    <img src="{{ asset('images/material/komoproof/img-content-ub-202-material.webp') }}"
                                        class="object-cover w-full h-full" alt="">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="py-4 px-5 h-[471px]">
                            ...
                            <div>
                                <ul class="list-disc pl-5 text-zinc-500 text-lg font-normal leading-7 tracking-tighter">
                                    <li>Dinding bangunan atau apartemen</li>
                                    <li>Basement</li>
                                    <li>Dinding yang membutuhkan lapisan pelindung tahain air dan elastis</li>
                                    <li>Warna - Abu-abu, Hijau</li>
                                    <li>Rasio Mixing - 4 : 1</li>
                                    <li>Potlife - 2 jam</li>
                                    <li>Kering Sentuh (30°) - 8 jam</li>
                                    <li>Jumlah Teoritis (1000μm) - 1.5 kg/m²</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-stone-50 w-full md:flex-1 rounded-[20px] shadow-sm overflow-hidden">
                        ...
                        <div class="relative h-40 2xl:h-56 rounded-t-[20px] px-5 py-7.5 overflow-hidden">
                            <!-- Background image -->
                            <div class="absolute inset-0 bg-cover bg-center"
                                style="background-image: url('{{ asset('images/material/komoproof/img-ua-200-material.png') }}');">
                            </div>
                            <!-- Overlay hitam 50% -->
                            <div class="absolute inset-0 bg-black/50"></div>
                            ...
                            <div class="relative">
                                <div class="w-28 2xl:w-36 h-28 2xl:h-36">
                                    <img src="{{ asset('images/material/komoproof/img-content-ua-200-material.webp') }}"
                                        class="object-cover w-full h-full" alt="">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="py-4 px-5 h-[471px]">
                            <div class="">
                                <h5 class="text-xl font-bold tracking-tight leading-loose text-black">
                                    BODYCOAT POLYUREA MODIFIED COATING
                                </h5>
                            </div>
                            <div class="mb-1.5">
                                <p class="text-lg font-normal tracking-tightest leading-relaxed text-black">
                            ...
                            <div>
                                <ul
                                    ...
                                    <li>Struktur yang membutuhkan lapisan pelindung tahan air dan elastis</li>
                                    <li>Warna - Abu-abu, Hijau</li>
                                    <li>Rasio Mixing - 25 menit</li>
                                    <li>Kering keras (20°) - 10 jam</li>
                                    <li>Jumlah Teoritis (2 mm) - 2.6 kg/m²</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="relative h-[714px] overflow-hidden rounded-lg">
                            ...
                            <div class="hidden duration-700 ease-in-out" data-carousel-item>
                                <div class="h-[714px] bg-stone-50  rounded-2xl">
                                    <div class="h-96 bg-white overflow-hidden px-5 py-4">
                                        <div>
                                            <img src="{{ asset('images/material/mesin-dan-perlengkapan/img-content-ch-600-auto-1-material.webp') }}"
                                ...
                                <div class="h-[714px] bg-stone-50  rounded-2xl">
                                    <div class="h-96 bg-white overflow-hidden px-5 py-4">
                                        <div class="flex justify-center items-center h-full">
                                            <img src="{{ asset('images/material/mesin-dan-perlengkapan/img-content-ch-600-auto-2-material.webp') }}"
                            ...
                            <div class="hidden duration-700 ease-in-out" data-carousel-item>
                                <div class="h-[714px] bg-stone-50  rounded-2xl">
                                    <div class="h-96 bg-white overflow-hidden px-5 py-4">
                                        <div class="flex justify-center items-center h-full">
                                            <img src="{{ asset('images/material/mesin-dan-perlengkapan/img-content-ch-600-auto-3-material.webp') }}"
                        ...
                        <div class="relative h-[714px] overflow-hidden rounded-lg">
                            ...
                            <div class="hidden duration-700 ease-in-out" data-carousel-item>
                                <div class="h-[714px] bg-stone-50  rounded-2xl">
                                    <div class="h-96 bg-white flex justify-center overflow-hidden px-5 py-4">
                                        <div>
                                            <img src="{{ asset('images/material/mesin-dan-perlengkapan/img-content-ch-100-1-material.webp') }}"
                            ...
                            <div class="hidden duration-700 ease-in-out" data-carousel-item>
                                <div class="h-[714px] bg-stone-50  rounded-2xl">
                                    <div class="h-96 bg-white flex justify-center overflow-hidden px-5 py-4">
                                        <div>
                                            <img src="{{ asset('images/material/mesin-dan-perlengkapan/img-content-ch-100-2-material.webp') }}"
                                                class="w-80 h-96 object-cover" alt="Gambar Penyedot Debu">
                                        </div>
                                    </div>
                                    <div class="px-5 py-4">
                ...
                <div id="swiper-1">
                    <div class="mb-5">
                        <p class="text-black text-2xl font-medium leading-7 tracking-tightest">Untuk beton medium</p>
                    </div>
                        ...
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide bg-white w-[289px] sm:w-[250px] md:w-[289px] flex-shrink-0">
                                <div class="bg-stone-50 flex justify-center items-center h-72">
                                    <img src="{{ asset('images/material/mata-gerinda/img-content-polishing-4-material.webp') }}"
                                        alt="" class="object-cover w-40 h-40">
                                </div>
                                <div class="flex justify-between">
                                    <p class="text-black text-lg font-medium tracking-tightest">Polishing</p>
                ...
                <div id="swiper-2" class="mt-12.5">
                    <div class="mb-5">
                        <p class="text-black text-2xl font-medium leading-7 tracking-tightest">Untuk beton keras
                            <span class="text-neutral-400">(Menghilangkan Lapisan Epoxy, Coating, Rekatan dan
                                Coaltar)</span>
                        </p>
                    </div>
                    <div class="swiper swiper2">
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide bg-white w-[289px] sm:w-[250px] md:w-[289px] flex-shrink-0">
                                <div class="bg-stone-50 flex justify-center items-center h-72">
                                    <img src="{{ asset('images/material/mata-gerinda/img-content-mega-4-material.webp') }}"
                                        alt="" class="object-cover w-40 h-40">
                                </div>
                                <div class="flex justify-between">
                                    <p class="text-black text-lg font-medium tracking-tightest">Mega</p>
                                    <p class="text-neutral-400 text-lg font-medium tracking-tightest">4”</p>
                                </div>
                            </div>
                            ...
                            <div class="swiper-slide bg-white w-[289px] sm:w-[250px] md:w-[289px] flex-shrink-0">
                                <div class="bg-stone-50 flex justify-center items-center h-72">
                                    <img src="{{ asset('images/material/mata-gerinda/img-content-super-multi-4-material.webp') }}"
                                        alt="" class="object-cover w-40 h-40">
                                </div>
                                <div class="flex justify-between">
                                    <p class="text-black text-lg font-medium tracking-tightest">Super Multi</p>
                                    <p class="text-neutral-400 text-lg font-medium tracking-tightest">4”</p>
                                </div>
                            </div>
                            ...
                            <div class="swiper-slide bg-white w-[289px] sm:w-[250px] md:w-[289px] flex-shrink-0">
                                <div class="bg-stone-50 flex justify-center items-center h-72">
                                    <img src="{{ asset('images/material/mata-gerinda/img-content-ultra-black-4-material.png') }}"
                                        alt="" class="object-cover w-40 h-40">
                                </div>
                                <div class="flex justify-between">
                                    <p class="text-black text-lg font-medium tracking-tightest">Ultra Black</p>
                                    <p class="text-neutral-400 text-lg font-medium tracking-tightest">4”</p>
                                </div>
                            </div>
                            ...
                            <div class="swiper-slide bg-white w-[289px] sm:w-[250px] md:w-[289px] flex-shrink-0">
                                <div class="bg-stone-50 flex justify-center items-center h-72">
                                    <img src="{{ asset('images/material/mata-gerinda/img-content-mega-7-material.webp') }}"
                                        alt="" class="object-cover w-40 h-40">
                                </div>
                                <div class="flex justify-between">
                                    <p class="text-black text-lg font-medium tracking-tightest">Mega</p>
                            ...
                            <div class="swiper-slide bg-white w-[289px] sm:w-[250px] md:w-[289px] flex-shrink-0">
                                <div class="bg-stone-50 flex justify-center items-center h-72">
                                    <img src="{{ asset('images/material/mata-gerinda/img-content-super-multi-7-material.webp') }}"
                                        alt="" class="object-cover w-40 h-40">
                                </div>
                                <div class="flex justify-between">
                                    <p class="text-black text-lg font-medium tracking-tightest">Super Multi</p>
                ...
                <div id="swiper-3" class="mt-12.5">
                    <div class="mb-5">
                        <p class="text-black text-2xl font-medium leading-7 tracking-tightest">Untuk beton halus
                        </p>
                    </div>
                    <div class="swiper swiper3">
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide bg-white w-[289px] sm:w-[250px] md:w-[289px] flex-shrink-0">
                                <div class="bg-stone-50 flex justify-center items-center h-72">
                                    <img src="{{ asset('images/material/mata-gerinda/img-content-gold-king-4-material.webp') }}"
                                        alt="" class="object-cover w-40 h-40">
                                </div>
                                <div class="flex justify-between">
                                    <p class="text-black text-lg font-medium tracking-tightest">Gold King</p>
                                    <p class="text-neutral-400 text-lg font-medium tracking-tightest">4”</p>
                                </div>
                            </div>
                            ...
                            <div class="swiper-slide bg-white w-[289px] sm:w-[250px] md:w-[289px] flex-shrink-0">
                                <div class="bg-stone-50 flex justify-center items-center h-72">
                                    <img src="{{ asset('images/material/mata-gerinda/img-content-super-gold-4-material.webp') }}"
                                        alt="" class="object-cover w-40 h-40">
                                </div>
                                <div class="flex justify-between">
                                    <p class="text-black text-lg font-medium tracking-tightest">Super Gold</p>
                                    <p class="text-neutral-400 text-lg font-medium tracking-tightest">4”</p>
                                </div>
                            </div>
                            ...
                            <div class="swiper-slide bg-white w-[289px] sm:w-[250px] md:w-[289px] flex-shrink-0">
                                <div class="bg-stone-50 flex justify-center items-center h-72">
                                    <img src="{{ asset('images/material/mata-gerinda/img-content-gold-king-7-material.webp') }}"
                                        alt="" class="object-cover w-40 h-40">
                                </div>
                                <div class="flex justify-between">
                                    <p class="text-black text-lg font-medium tracking-tightest">Gold King</p>
                            ...
                            <div class="swiper-slide bg-white w-[289px] sm:w-[250px] md:w-[289px] flex-shrink-0">
                                <div class="bg-stone-50 flex justify-center items-center h-72">
                                    <img src="{{ asset('images/material/mata-gerinda/img-content-super-multi-7-gold-material.webp') }}"
                                        alt="" class="object-cover w-40 h-40">
                                </div>
                                <div class="flex justify-between">
                                    <p class="text-black text-lg font-medium tracking-tightest">Super Multi</p>
                ...
                <div id="swiper-4" class="mt-12.5">
                    <div class="mb-5">
                        <p class="text-black text-2xl font-medium leading-7 tracking-tightest">PCD</p>
                    </div>
                    <div class="swiper swiper4">
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide bg-white w-[289px] sm:w-[250px] md:w-[289px] flex-shrink-0">
                                ...
                                <div class="">
                                    <p class="text-black text-lg font-medium tracking-tightest">PCD<span class="">(untuk mesin)</span> </p>
                                </div>
                            </div>
