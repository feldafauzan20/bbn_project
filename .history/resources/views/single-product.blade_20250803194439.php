<x-layouts.main-layout>
    <x-slot:title>
        Detail Product | BIMA BAHAMA NUSANTARA
    </x-slot:title>
    ...
    <nav id="navbar" class="fixed top-0 left-0 w-full z-50 ">
        <div class="max-w-[1500px] lg:mx-36 2xl:mx-61">
            <div class="relative flex py-6 items-center justify-between md:px-3 lg:px-0">
                ...
                <div class="flex items-center justify-between w-full">
                    ...
                    <div class="hidden md:hidden" id="whatsapp-chat-md-to-lg">
                        <a href="#"
        ...
        <!-- Mobile menu -->
        <div id="mobile-menu" class="hidden md:block px-3 pt-6 pb-4 space-y-3 tracking-tighter text-lg">
    ...
    <section>
        <div class="relative">
            ...
            <div class="relative h-fit w-full">
                <div class="pt-32 pb-31 md:pb-26.5 mx-5 lg:mx-36 2xl:mx-61 max-w-[1500px] " id="hero-section">
                    <div class="w-96 md:w-120">
                        <h2 class="text-white text-6xl font-semibold tracking-tightest">
    ...
    {{-- DESCRIPTION START --}}
    <section>
        <div class="mx-5 mt-18 md:mt-7 mb-12.5 md:mb-8 ">
            ...
            <div class="md:flex md:justify-between">
                <div class="flex md:h-20">
                    <a href=""
                        class="px-14 py-7 text-white bg-black rounded-full text-lg tracking-tightest font-semibold leading-tight hover:bg-blue-600 transition duration-500 ">Bangunan
                        Gedung</a>
                </div>
    ...
    {{-- ANOTHER PROJECTS START --}}
    <section>
        <div class="mx-5 my-12.5 md:my-12.5">
            <div class="w-96 md:w-110  mb-12.5">
                <h2 class="text-black text-2xl font-normal tracking-tightest">
                    Harmonious blend of traditional Balinese aesthetics and modern sustainability practices.
                </h2>
            </div>
            <div
                class="grid place-items-center md:place-items-stretch grid-cols-1 md:grid-cols-2 gap-y-12.5 md:gap-x-7.5 bg-yellow-300">
                <div class="w-80 md:w-full h-96 rounded-2xl overflow-hidden">
    ...
    {{-- ANOTHER PROJECTS END --}}

    {{-- ANOTHER PROJECTS 2 START --}}
    <section>
        <div class="mx-5 md:flex md:justify-end mb-12.5">
            <div class="w-96 md:w-110">
                <h2 class="text-black text-2xl font-normal tracking-tightest">
                    Harmonious blend of traditional Balinese aesthetics and modern sustainability practices.
                </h2>
            </div>
    ...
    {{-- ANOTHER PROJECTS 2 END --}}

    {{-- NEXT PROJECTS START --}}
    <section>
        <div class="mx-5 md:bg-red-400 mb-10.5 lg:mx-36 2xl:mx-61 mt-12.5 md:mt-20 lg:mt-29 md:mb-20 lg:mb-8 max-w-[1500px]"
            id="journal-section">
            <div class="md:flex md:justify-between bg-blue-400 md:mb-9.5">
                <div class="w-full md:flex md:items-center md:w-110 bg-yellow-400 lg:w-200 mb-8 md:mb-0">
                    <h2
                        class="text-black text-5xl lg:text-6xl font-semibold tracking-tightest lg:tracking-tighter text-center md:text-start leading-10 md:leading-[52px]">
                        Next Projects</h2>
                </div>
                <div class="flex justify-center mb-12.5 md:mb-0 bg-amber-700">
                    <a href="#"
