        ...
        <section>
            <div class="relative pb-10 lg:pb-40">
                ...
                <div class="relative h-fit w-full">
                    <div id="big-hero-content-1"
                        class=" pt-32 text-center bg-blue-500 flex flex-col items-center w-full mx-auto">
                        <div class="bg-red-400 w-96">
                            <h2 class="text-5xl md:text-7xl lg:text-8xl font-semibold tracking-tightest text-white ">
                                Mari Terhubung
                            </h2>
                        </div>
