<x-layouts.main-layout>
    ...
    <section>
        <div class="relative">
            ...
            <div class="relative h-fit 2xl:h-[600px] w-full">
                <div class="pt-32 pb-31 md:pb-26.5 mx-5 lg:mx-36 2xl:mx-61 max-w-[1500px] lg:h-full lg:flex lg:items-center"
                    id="hero-section">
                    <div class="w-96 md:w-120 lg:bg-red-300 lg:w-200">
                        <h2 class="text-white text-6xl lg:text-8xl font-semibold tracking-tightest">
