<x-layouts.main-layout>
    ...
    <section>
        <div class="mt-12.5 md:mt-20 mx-5 lg:mx-36 pb-7.5 lg:pb-26 lg:flex lg:justify-between ">
            <div class="mb-7.5 md:mb-20 2xl:w-[874px] lg:w-[700px] bg-emerald-300">
                <div class="pb-8.5">
            ...
            <div
                class="grid grid-cols-1 lg:w-96 bg-cyan-600 lg:h-fit place-items-center gap-y-7.5 lg:gap-y-6 md:grid-cols-2 lg:grid-cols-1 px-5 md:px-0 md:gap-x-7.5 lg:gap-x-0">
                <div
    ...
    {{-- SERVICES START --}}
    <section>
        <div class="mx-5 lg:mx-36 2xl:mx-61 mb-10 max-w-[1500px] bg-red-500" id="services-section">
            <div class="lg:flex lg:justify-between md:mb-10 lg:mb-7.5">
                <div class="w-full lg:flex lg:items-center lg:w-200 mb-8">
                    <h2
                        ...
                        Lihat Projek <br class="hidden lg:inline" /> Kami Lainnya</h2>
                </div>
