                            ...
                            <form action="">
                                <div class="mb-5">
                                    ...
                                    <input type="email" id="email"
                                        class="shadow-xs bg-neutral-800-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
