    ...
    <section>
        <div class="bg-red-300 mt-12.5 mx-5">
            <div class="mb-7.5">
                ...
                <div class="bg-yellow-400 mb-7.5">
                    <ol
            ...
            <div class="grid grid-cols-1 place-items-center md:grid-cols-2 lg:grid-cols-1">
                <div class="w-80 h-64 p-7 bg-stone-50 rounded-2xl flex flex-col justify-start items-start ">
                    <div class="bg-red-400">
                        <h2 class="text-black text-2xl font-semibold tracking-tightest leading-10">Follow Us on Social
                            Media</h2>
                    </div>
                    <div class="bg-yellow-500 my-5 w-60">
