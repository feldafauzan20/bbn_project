<x-layouts.main-layout>
    ...
    <section>
        <div class="relative">
            ...
            <div class="relative h-fit w-full">
                <div class="pt-32 pb-5 md:pb-20 mx-5 md:bg-red-500  lg:mx-36 2xl:mx-61 flex flex-col lg:flex-row lg:justify-between max-w-[1500px]"
                    id="hero-section">
                    <div class="">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 px-5 md:px-0 gap-y-15">
    ...
    <section class="mx-5 lg:mx-36 2xl:mx-61 max-w-[1500px] md:hidden lg:blovk">
        <x-contact-us-card />
    </section>
