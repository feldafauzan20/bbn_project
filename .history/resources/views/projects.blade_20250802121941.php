<x-layouts.main-layout>
        ...
        <div class="mx-5 lg:mx-24 2xl:mx-61 mb-12.5 max-w-[1500px]">
            <div
                ...
                <div class="gap-y-13 lg:gap-y-0 grid grid-cols-1">
                    ...
                    {{-- CARD 3 --}}
                    <div class="w-full bg-white flex flex-col h-full md:h-[600px] lg:h-fit lg:flex-row">
                ...
                <div class="gap-y-13 lg:gap-y-32 grid grid-cols-1 lg:pl-12 lg:w-full">
                    ...
                    {{-- CARD 6 --}}
                    <div class="w-full bg-white flex flex-col h-full md:h-[600px] lg:h-[623px]">
    ...
    <section class="mx-5 lg:mx-36 2xl:mx-61 ">
        <x-contact-us-card />
    </section>
    {{-- CONTACT COMPONENT END --}}

    {{-- FOOTER COMPONENT START --}}
    <section class="mx-5 lg:mx-36 2xl:mx-61 mt-20.5 md:mt-20 lg:mt-22 ">
        <x-footer-component />
    </section>
