        ...
        <section>
            <div class="relative">
                ...
                <div class="relative h-fit w-full">
                    <div id="big-hero-content-1" class="pt-32 mx-5 flex flex-col">
                        ...
                        <div class="p-5 bg-neutral-900/80 rounded-[20px] outline-1 outline-offset-[-1px] outline-black">
                            <form action="">
                                ...
                                <div>
                                    <button type="submit"
                                        class="flex items-center justify-between bg-white text-black font-semibold w-full max-w-md px-4 py-2 rounded-full shadow-md hover:shadow-lg transition duration-300">
