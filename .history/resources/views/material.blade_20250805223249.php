            ...
            <div>
                ...
                <div class="lg:bg-red-500 grid grid-cols-1 lg:grid-cols-3 md:place-items-center gap-y-11.5 md:gap-y-7">
                    <div class="bg-stone-50 w-full md:w-96 md:flex-1 rounded-[20px] shadow-sm overflow-hidden">
                        <div
                            class="h-96 lg:w-80 lg:h-96 flex justify-center items-center 2xl:h-56 rounded-t-[20px] px-5 lg:px-15 py-7.5 overflow-hidden">

                            <div class="">
                                <div class="w-60 bg-yellow-700 2xl:w-36 h-56  2xl:h-36">
