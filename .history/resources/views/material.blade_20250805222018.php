    ...
    <section>
        <div class="mx-5 lg:mx-36 2xl:mx-61 mt-12 md:mt-18.5 lg:mt-23 max-w-[1500px]">
            ...
            <div>
                ...
                {{-- Komowrap --}}
                <div class="md:bg-red-500 grid grid-cols-1 lg:grid-cols-3 md:place-items-center gap-y-11.5 md:gap-y-7">
                    <div class="bg-stone-50 w-full md:w-96 md:flex-1 rounded-[20px] shadow-sm overflow-hidden">
                        ...
                        <div class="py-4 px-5 h-24">
                            <div class="">
                                <p
                                    class="text-lg md:text-xl font-normal tracking-tight leading-relaxed lg:leading-loose text-black">
