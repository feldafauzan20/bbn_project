    ...
    <section>
        <div class="relative">
            ...
            <div class="relative h-fit w-full">
                <div class="pt-32 pb-14 md:pb-20 mx-5 lg:mx-36 flex flex-col lg:flex-row lg:justify-between md:bg-red-300"
                    id="big-hero-content-1">
                    <div class="lg:bg-purple-400">
                        <div class=" mx-auto w-96 md:w-full lg:w-120 mb-5 lg:mb-8.5 md:bg-yellow-400">
                            <h2
                        ...
                        <div class="md:w-[470px] bg-blue-500 md:mx-auto">
                            <div class="w-85 md:w-96 lg:w-100 lg:bg-green-400 mx-auto lg:mx-0">
                                <p
                    ...
                    <div class="md:px-3 lg:px-0 lg:bg-cyan-300">
                        <div
