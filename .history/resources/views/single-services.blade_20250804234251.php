<x-layouts.main-layout>
    ...
    <section>
        <div class="mx-5 lg:mx-36 2xl:mx-61 mb-10 max-w-[1500px] bg-red-500" id="services-section">
            <div class="lg:flex lg:justify-between md:mb-10 lg:mb-7.5 lg:h-[166px] bg-yellow-600">
                <div class="w-full lg:w-100 mb-8 lg:bg-blue-500 lg:h-full">
                    <h2
                ...
                <div class="lg:bg-purple-400 lg:flex lg:items-center lg:h-full">
