<x-layouts.main-layout>
    ...
    {{-- HERO START --}}
    <section>
        <div class="mx-5 lg:mx-36 2xl:mx-61 pt-22 md:pt-34 pb-20 lg:pb-42 lg:bg-red-400">
            <div class="mx-auto w-96 md:w-[530px] lg:w-[736px] mb-8.5 lg:mb-6">
                <h2
                    ...
                    Layanan Konstruksi <br class="hidden md:inline" /> dan Struktur Menyeluruh
                </h2>
            </div>
            <div class="w-90 md:w-[620px] lg:w-[740px] mx-auto bg-cyan-800">
