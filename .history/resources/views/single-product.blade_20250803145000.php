<x-layouts.main-layout>
    ...
    <section>
        <div class="mx-5 bg-red-400 mt-12.5">
            <div class="w-96 mb-12.5">
            ...
            <div class="px-5 bg-yellow-400 grid grid-cols-1 md:grid-cols-2">
                <div class="h-96 rounded-2xl">
                    <img src="{{ asset('images/single-product/img-family-room.webp') }}" class="object-cover"
                        alt="">
                </div>
            </div>
        </div>
